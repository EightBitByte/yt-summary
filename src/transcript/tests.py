...
class TranscriptsTests(unittest.TestCase):
    def test_id(self):
        self.assertEqual(get_transcript_text("wNTGYSG-SFk"), racoon_text)
    
    def test_playlist_link(self):
        self.assertEqual(get_transcript_text("https://www.youtube.com/watch?v=wNTGYSG-SFk&list=PL0-euOPmh12FELJwDVeWDGV7cinZBIIqF&index=2&ab_channel=GianniMatragrano"), racoon_text)
    
    def test_short_link(self):
        self.assertEqual(get_transcript_text("https://youtu.be/wNTGYSG-SFk?si=fFklBybQKpFYPvnT"), racoon_text)

    def test_shorts(self):
        # Testing #shorts on YouTube
        self.assertEqual(get_transcript_text("https://www.youtube.com/watch?v=B0X3xburLxo&list=LL&index=4&ab_channel=PirateSoftware"),
    ...
    def test_expletives(self):
        self.assertEqual(get_transcript_text("dpTte1scAm0"), 
    ...
    def test_timestamp_link(self):
        self.assertEqual(get_transcript_text("https://youtu.be/ugn5kYgIqXo?si=9uG10Nhnfe59cYDo&t=11"),
    ...
    def test_1hr_podcast(self):
        ...
        self.assertEqual(get_transcript_text("https://www.youtube.com/watch?v=jreBmGkuEBc&ab_channel=TheoVon"),
                         text)
